...
Elm.Main.make = function (_elm) {
   ...
   $List = Elm.List.make(_elm),
   $Maybe = Elm.Maybe.make(_elm),
   $MouseTouch = Elm.MouseTouch.make(_elm),
   $MouseTouch$Eval = Elm.MouseTouch.Eval.make(_elm),
   $Result = Elm.Result.make(_elm),
   $Signal = Elm.Signal.make(_elm),
   ...
   model) {
      ...
      _L.fromArray([A2($Html.div,
                   ...
                   ,A2($Html.div,
                   A2($List._op["::"],
                   $Html$Attributes.$class("counter"),
                   $MouseTouch.onMultiple(_L.fromArray([{_: {}
                                                        ,$eval: A2($MouseTouch$Eval.swipeRight,
                                                        50,
                                                        50)
                                                        ,decoder: $Json$Decode.value
                                                        ,key: "TapTest.Swipe.Increment"
                                                        ,options: $Html$Events.defaultOptions
                                                        ,pruneBelow: $Time.second / 2
                                                        ,toMessage: function (_v1) {
                                                           return function () {
                                                              return A2($Signal.message,
                                                              address,
                                                              Increment);
                                                       ...
                                                       ,{_: {}
                                                        ,$eval: A2($MouseTouch$Eval.swipeLeft,
                                                        50,
                                                        50)
                                                        ,decoder: $Json$Decode.value
   ...
   var main = $Signal.map(view(actions.address))(A3($Signal.foldp,
   update,
   0,
   actions.signal));
...
Elm.MouseTouch = Elm.MouseTouch || {};
Elm.MouseTouch.make = function (_elm) {
   "use strict";
   _elm.MouseTouch = _elm.MouseTouch || {};
   if (_elm.MouseTouch.values)
   return _elm.MouseTouch.values;
   var _op = {},
   _N = Elm.Native,
   _U = _N.Utils.make(_elm),
   _L = _N.List.make(_elm),
   $moduleName = "MouseTouch",
   $Basics = Elm.Basics.make(_elm),
   $Html = Elm.Html.make(_elm),
   $Html$Events = Elm.Html.Events.make(_elm),
   $Json$Decode = Elm.Json.Decode.make(_elm),
   $List = Elm.List.make(_elm),
   $Maybe = Elm.Maybe.make(_elm),
   $Native$MouseTouch = Elm.Native.MouseTouch.make(_elm),
   $Result = Elm.Result.make(_elm),
   $Signal = Elm.Signal.make(_elm),
   $Time = Elm.Time.make(_elm);
   var onMultiple = $Native$MouseTouch.onMultiple;
   var onWithOptions = $Native$MouseTouch.on;
   var on = F5(function ($eval,
   pruneBelow,
   key,
   decoder,
   toMessage) {
      return A6($Native$MouseTouch.on,
      $eval,
   ...
   var messageOn = F5(function ($eval,
   pruneBelow,
   key,
   addr,
   msg) {
   ...
   var Move = {ctor: "Move"};
   var Leave = {ctor: "Leave"};
   var End = {ctor: "End"};
   var Start = {ctor: "Start"};
   var Touch = {ctor: "Touch"};
   var Mouse = {ctor: "Mouse"};
   _elm.MouseTouch.values = {_op: _op
                            ,on: on
                            ,onWithOptions: onWithOptions
                            ,messageOn: messageOn
...
Elm.MouseTouch = Elm.MouseTouch || {};
Elm.MouseTouch.Eval = Elm.MouseTouch.Eval || {};
Elm.MouseTouch.Eval.make = function (_elm) {
   "use strict";
   _elm.MouseTouch = _elm.MouseTouch || {};
   _elm.MouseTouch.Eval = _elm.MouseTouch.Eval || {};
   if (_elm.MouseTouch.Eval.values)
   return _elm.MouseTouch.Eval.values;
   var _op = {},
   _N = Elm.Native,
   _U = _N.Utils.make(_elm),
   _L = _N.List.make(_elm),
   $moduleName = "MouseTouch.Eval",
   $Basics = Elm.Basics.make(_elm),
   $Html = Elm.Html.make(_elm),
   $List = Elm.List.make(_elm),
   $Maybe = Elm.Maybe.make(_elm),
   ...
   $Signal = Elm.Signal.make(_elm),
   $Time = Elm.Time.make(_elm);
   var swipeLeft = F3(function (tolerance,
   minSwipeDistance,
   events) {
      return function () {
         var xBigger = F2(function (_v0,
         _v1) {
            return function () {
               switch (_v1.ctor)
               {case "_Tuple2":
                               ...
                               switch (_v0._1.ctor)
                                 {case "_Tuple2":
                                    switch (_v0._1._1.ctor)
                                      {case "_Tuple2":
                                         return function () {
                                              var newSmaller = !_U.eq(_v0._0._1,
                                              $MouseTouch.Move) ? _v1._1 : _v1._1 && _U.cmp(_v1._0,
                                              _v0._1._1._0) < 0;
                                              return {ctor: "_Tuple2"
                                                     ,_0: _v0._1._1._0
                                                     ,_1: newSmaller};
         ...
         return function () {
            switch (events.ctor)
            {case "::":
               switch (events._0.ctor)
                 {case "_Tuple2":
                    switch (events._0._0.ctor)
                      {case "_Tuple2":
                         switch (events._0._0._0.ctor)
                           {case "Touch":
                              switch (events._0._0._1.ctor)
                                {case "End":
                                   switch (events._0._1.ctor)
                                     {case "_Tuple2":
                                        switch (events._0._1._1.ctor)
                                          {case "_Tuple2":
                                             return function () {
                                                  var _v25 = A2($List.foldl,
                                                  xBigger,
                                                  {ctor: "_Tuple2"
                                                  ,_0: -1
                                                  ,_1: true})(A2($List.filter,
                                                  function (_v28) {
                                                     return function () {
                                                        switch (_v28.ctor)
                                                        {case "_Tuple2":
                                                           switch (_v28._0.ctor)
                                                             {case "_Tuple2":
                                                                return _U.eq(_v28._0._0,
                                                                  $MouseTouch.Touch);}
                                                             break;}
                                                        _U.badCase($moduleName,
                                                        "on line 229, column 55 to 65");
                                                     }();
                                                  },
                                                  events._1));
                                                  switch (_v25.ctor)
                                                       ...
                                                       {case false:
                                                          ...
                                                          return function () {
                                                               ...
                                                               function (_v45) {
                                                                  return function () {
                                                                     ...
                                                                     {case "_Tuple2":
                                                                        switch (_v45._0.ctor)
                                                                          {case "_Tuple2":
                                                                             return _U.eq(_v45._0._1,
                                                                               $MouseTouch.Start);}
                                                                          break;}
                                                                     _U.badCase($moduleName,
                                                                     "on line 231, column 57 to 67");
                                                                  }();
                                                               },
                                                               events._1);
                                                               switch (_v34.ctor)
                                                               {case "::":
                                                                  switch (_v34._0.ctor)
                                                                    {case "_Tuple2":
                                                                       switch (_v34._0._0.ctor)
                                                                         {case "_Tuple2":
                                                                            switch (_v34._0._0._0.ctor)
                                                                              {case "Touch":
                                                                                 switch (_v34._0._0._1.ctor)
                                                                                   {case "Start":
                                                                                      switch (_v34._0._1.ctor)
                                                                                        {case "_Tuple2":
                                                                                           switch (_v34._0._1._1.ctor)
                                                                                             {case "_Tuple2":
                                                                                                return _U.cmp($Basics.abs(_v34._0._1._1._0 - events._0._1._1._0),
                                                                                                  tolerance) > 0 && _U.cmp($Basics.abs(_v34._0._1._1._1 - events._0._1._1._1),
                                                                                                  minSwipeDistance) < 0;}
                                                                                             break;}
                                                                                        break;}
                                                                                   break;}
   ...
   var swipeRight = F3(function (tolerance,
   minSwipeDistance,
   events) {
      return function () {
         var xSmaller = F2(function (_v51,
         _v52) {
            return function () {
               switch (_v52.ctor)
               {case "_Tuple2":
                       ...
                       {case "_Tuple2":
                          switch (_v51._0.ctor)
                            {case "_Tuple2":
                               switch (_v51._1.ctor)
                                 {case "_Tuple2":
                                    switch (_v51._1._1.ctor)
                                      {case "_Tuple2":
                                         return function () {
                                              var newSmaller = !_U.eq(_v51._0._1,
                                              $MouseTouch.Move) ? _v52._1 : _v52._1 && _U.cmp(_v52._0,
                                              _v51._1._1._0) > 0;
                                              return {ctor: "_Tuple2"
                                                     ,_0: _v51._1._1._0
                                                     ,_1: newSmaller};
                                                  ...
                                                  function (_v79) {
                                                     return function () {
                                                        ...
                                                        {case "_Tuple2":
                                                           switch (_v79._0.ctor)
                                                             {case "_Tuple2":
                                                                return _U.eq(_v79._0._0,
                                                                  $MouseTouch.Touch);}
                                                             break;}
                                                        _U.badCase($moduleName,
                                                        "on line 200, column 55 to 65");
                                                     }();
                                                  },
                                                  events._1));
                                                  switch (_v76.ctor)
                                                       ...
                                                       {case false:
                                                          ...
                                                          return function () {
                                                               ...
                                                               function (_v96) {
                                                                  return function () {
                                                                     ...
                                                                     {case "_Tuple2":
                                                                        switch (_v96._0.ctor)
                                                                          {case "_Tuple2":
                                                                             return _U.eq(_v96._0._1,
                                                                               $MouseTouch.Start);}
                                                                          break;}
                                                                     _U.badCase($moduleName,
                                                                     "on line 202, column 57 to 67");
                                                                  }();
                                                               },
                                                               events._1);
                                                               switch (_v85.ctor)
                                                               {case "::":
                                                                  switch (_v85._0.ctor)
                                                                    {case "_Tuple2":
                                                                       switch (_v85._0._0.ctor)
                                                                         {case "_Tuple2":
                                                                            switch (_v85._0._0._0.ctor)
                                                                              {case "Touch":
                                                                                 switch (_v85._0._0._1.ctor)
                                                                                   {case "Start":
                                                                                      switch (_v85._0._1.ctor)
                                                                                        {case "_Tuple2":
                                                                                           switch (_v85._0._1._1.ctor)
                                                                                             {case "_Tuple2":
                                                                                                return _U.cmp($Basics.abs(_v85._0._1._1._0 - events._0._1._1._0),
                                                                                                  tolerance) > 0 && _U.cmp($Basics.abs(_v85._0._1._1._1 - events._0._1._1._1),
                                                                                                  minSwipeDistance) < 0;}
                                                                                             break;}
                                                                                        break;}
                                                                                   break;}
   ...
   var swipeUp = F3(function (tolerance,
   minSwipeDistance,
   events) {
      return function () {
         var yBigger = F2(function (_v102,
         _v103) {
            return function () {
               switch (_v103.ctor)
               {case "_Tuple2":
                  return function () {
                       switch (_v102.ctor)
                       {case "_Tuple2":
                          switch (_v102._0.ctor)
                            {case "_Tuple2":
                               switch (_v102._1.ctor)
                                 {case "_Tuple2":
                                    switch (_v102._1._1.ctor)
                                      {case "_Tuple2":
                                         return function () {
                                              var newSmaller = !_U.eq(_v102._0._1,
                                              $MouseTouch.Move) ? _v103._1 : _v103._1 && _U.cmp(_v103._0,
                                              _v102._1._1._1) < 0;
                                              return {ctor: "_Tuple2"
                                                     ,_0: _v102._1._1._1
                                                     ,_1: newSmaller};
                                             ...
                                             return function () {
                                                  ...
                                                  function (_v130) {
                                                     return function () {
                                                        switch (_v130.ctor)
                                                        {case "_Tuple2":
                                                           switch (_v130._0.ctor)
                                                             {case "_Tuple2":
                                                                return _U.eq(_v130._0._0,
                                                                  $MouseTouch.Touch);}
                                                             break;}
                                                        _U.badCase($moduleName,
                                                        "on line 171, column 55 to 65");
                                                     }();
                                                  },
                                                  events._1));
                                                  switch (_v127.ctor)
                                                  {case "_Tuple2":
                                                     switch (_v127._1)
                                                       {case false:
                                                          ...
                                                          case true:
                                                          return function () {
                                                               var _v136 = A2($List.filter,
                                                               function (_v147) {
                                                                  return function () {
                                                                     switch (_v147.ctor)
                                                                     {case "_Tuple2":
                                                                        switch (_v147._0.ctor)
                                                                          {case "_Tuple2":
                                                                             return _U.eq(_v147._0._1,
                                                                               $MouseTouch.Start);}
                                                                          break;}
                                                                     _U.badCase($moduleName,
                                                                     "on line 173, column 57 to 67");
                                                                  }();
                                                               },
                                                               events._1);
                                                               switch (_v136.ctor)
                                                               {case "::":
                                                                  switch (_v136._0.ctor)
                                                                    {case "_Tuple2":
                                                                       switch (_v136._0._0.ctor)
                                                                         {case "_Tuple2":
                                                                            switch (_v136._0._0._0.ctor)
                                                                              {case "Touch":
                                                                                 switch (_v136._0._0._1.ctor)
                                                                                   {case "Start":
                                                                                      switch (_v136._0._1.ctor)
                                                                                        {case "_Tuple2":
                                                                                           switch (_v136._0._1._1.ctor)
                                                                                             {case "_Tuple2":
                                                                                                return _U.cmp($Basics.abs(_v136._0._1._1._0 - events._0._1._1._0),
                                                                                                  tolerance) < 0 && _U.cmp($Basics.abs(_v136._0._1._1._1 - events._0._1._1._1),
                                                                                                  minSwipeDistance) > 0;}
                                                                                             break;}
                                                                                        break;}
                                                                                   break;}
   ...
   var swipeDown = F3(function (tolerance,
   minSwipeDistance,
   events) {
      return function () {
         var ySmaller = F2(function (_v153,
         _v154) {
            return function () {
               switch (_v154.ctor)
               {case "_Tuple2":
                  return function () {
                       switch (_v153.ctor)
                       {case "_Tuple2":
                          switch (_v153._0.ctor)
                            {case "_Tuple2":
                               switch (_v153._1.ctor)
                                 {case "_Tuple2":
                                    switch (_v153._1._1.ctor)
                                      {case "_Tuple2":
                                         return function () {
                                              var newSmaller = !_U.eq(_v153._0._1,
                                              $MouseTouch.Move) ? _v154._1 : _v154._1 && _U.cmp(_v154._0,
                                              _v153._1._1._1) > 0;
                                              return {ctor: "_Tuple2"
                                                     ,_0: _v153._1._1._1
                                                     ,_1: newSmaller};
                                             ...
                                             return function () {
                                                  ...
                                                  function (_v181) {
                                                     return function () {
                                                        switch (_v181.ctor)
                                                        {case "_Tuple2":
                                                           switch (_v181._0.ctor)
                                                             {case "_Tuple2":
                                                                return _U.eq(_v181._0._0,
                                                                  $MouseTouch.Touch);}
                                                             break;}
                                                        _U.badCase($moduleName,
                                                        "on line 142, column 55 to 65");
                                                     }();
                                                  },
                                                  events._1));
                                                  switch (_v178.ctor)
                                                  {case "_Tuple2":
                                                     switch (_v178._1)
                                                       {case false:
                                                          ...
                                                          case true:
                                                          return function () {
                                                               var _v187 = A2($List.filter,
                                                               function (_v198) {
                                                                  return function () {
                                                                     switch (_v198.ctor)
                                                                     {case "_Tuple2":
                                                                        switch (_v198._0.ctor)
                                                                          {case "_Tuple2":
                                                                             return _U.eq(_v198._0._1,
                                                                               $MouseTouch.Start);}
                                                                          break;}
                                                                     _U.badCase($moduleName,
                                                                     "on line 144, column 57 to 67");
                                                                  }();
                                                               },
                                                               events._1);
                                                               switch (_v187.ctor)
                                                               {case "::":
                                                                  switch (_v187._0.ctor)
                                                                    {case "_Tuple2":
                                                                       switch (_v187._0._0.ctor)
                                                                         {case "_Tuple2":
                                                                            switch (_v187._0._0._0.ctor)
                                                                              {case "Touch":
                                                                                 switch (_v187._0._0._1.ctor)
                                                                                   {case "Start":
                                                                                      switch (_v187._0._1.ctor)
                                                                                        {case "_Tuple2":
                                                                                           switch (_v187._0._1._1.ctor)
                                                                                             {case "_Tuple2":
                                                                                                return _U.cmp($Basics.abs(_v187._0._1._1._0 - events._0._1._1._0),
                                                                                                  tolerance) < 0 && _U.cmp($Basics.abs(_v187._0._1._1._1 - events._0._1._1._1),
                                                                                                  minSwipeDistance) > 0;}
                                                                                             break;}
                                                                                        break;}
                                                                                   break;}
                         ...
                         switch (events._0._0._1.ctor)
                           {case "Start":
                              switch (events._0._1.ctor)
                                {case "_Tuple2":
                                   return {ctor: "_Tuple2"
                                          ,_0: $Maybe.Just(events._0._1._0)
                                          ,_1: _U.eq(events._0._0._0,
                                          $MouseTouch.Mouse) ? function () {
                                             var _v213 = A2($List.filter,
                                             function (_v222) {
                                                return function () {
                                                   switch (_v222.ctor)
                                                   {case "_Tuple2":
                                                      switch (_v222._0.ctor)
                                                        {case "_Tuple2":
                                                           return _U.eq(_v222._0._0,
                                                             $MouseTouch.Touch);}
                                                        break;}
                                                   _U.badCase($moduleName,
                                                   "on line 98, column 56 to 66");
                                                }();
                                             },
                                             events._1);
                                             switch (_v213.ctor)
                                             {case "::":
                                                switch (_v213._0.ctor)
                                                  {case "_Tuple2":
                                                     switch (_v213._0._0.ctor)
                                                       {case "_Tuple2":
                                                          switch (_v213._0._0._0.ctor)
                                                            {case "Touch":
                                                               switch (_v213._0._1.ctor)
                                                                 {case "_Tuple2":
                                                                    return $Maybe.Just(_v213._0._1._0);}
                                                                 break;}
                                                            break;}
                                                       break;}
                                                  break;}
   ...
   var start = start$(700 * $Time.millisecond);
   var click$ = F3(function (maxRange,
   minLast,
   events) {
      return function () {
         var $ = function () {
                              ...
                              switch (events._0._0._1.ctor)
                                {case "End":
                                   switch (events._0._1.ctor)
                                     {case "_Tuple2":
                                        return function () {
                                             var _v241 = A2($List.filter,
                                             function (_v250) {
                                                return function () {
                                                   switch (_v250.ctor)
                                                   {case "_Tuple2":
                                                      switch (_v250._0.ctor)
                                                        {case "_Tuple2":
                                                           return _U.eq(_v250._0._0,
                                                             $MouseTouch.Mouse) && !_U.eq(_v250._0._1,
                                                             $MouseTouch.Move);}
                                                        break;}
                                                   _U.badCase($moduleName,
                                                   "on line 46, column 44 to 67");
                                                }();
                                             },
                                             events._1);
                                             switch (_v241.ctor)
                                             {case "::":
                                                switch (_v241._0.ctor)
                                                  {case "_Tuple2":
                                                     switch (_v241._0._0.ctor)
                                                       {case "_Tuple2":
                                                          switch (_v241._0._0._0.ctor)
                                                            {case "Mouse":
                                                               switch (_v241._0._0._1.ctor)
                                                                 {case "Start":
                                                                    switch (_v241._0._1.ctor)
                                                                      {case "_Tuple2":
                                                                         return {ctor: "_Tuple2"
                                                                                ,_0: $Maybe.Just(events._0._1._0 - _v241._0._1._0)
                                                                                ,_1: function () {
                                                                                   var _v256 = A2($List.filter,
                                                                                   function (_v265) {
                                                                                      return function () {
                                                                                         switch (_v265.ctor)
                                                                                         {case "_Tuple2":
                                                                                            switch (_v265._0.ctor)
                                                                                              {case "_Tuple2":
                                                                                                 return _U.eq(_v265._0._0,
                                                                                                   $MouseTouch.Touch);}
                                                                                              break;}
                                                                                         _U.badCase($moduleName,
                                                                                         "on line 52, column 56 to 66");
                                                                                      }();
                                                                                   },
                                                                                   events);
                                                                                   switch (_v256.ctor)
                                                                                   {case "::":
                                                                                      switch (_v256._0.ctor)
                                                                                        {case "_Tuple2":
                                                                                           switch (_v256._0._0.ctor)
                                                                                             {case "_Tuple2":
                                                                                                switch (_v256._0._0._0.ctor)
                                                                                                  {case "Touch":
                                                                                                     switch (_v256._0._1.ctor)
                                                                                                       {case "_Tuple2":
                                                                                                          return $Maybe.Just(_v241._0._1._0 - _v256._0._1._0);}
                                                                                                       break;}
                                                                                                  break;}
                                                                                             break;}
                                                                                        break;}
                              ...
                              switch (events._0._0._1.ctor)
                                {case "End":
                                   switch (events._0._1.ctor)
                                     {case "_Tuple2":
                                        return function () {
                                             var _v280 = A2($List.filter,
                                             function (_v289) {
                                                return function () {
                                                   switch (_v289.ctor)
                                                   {case "_Tuple2":
                                                      switch (_v289._0.ctor)
                                                        {case "_Tuple2":
                                                           return _U.eq(_v289._0._0,
                                                             $MouseTouch.Touch) && !_U.eq(_v289._0._1,
                                                             $MouseTouch.Move);}
                                                        break;}
                                                   _U.badCase($moduleName,
                                                   "on line 33, column 44 to 67");
                                                }();
                                             },
                                             events._1);
                                             switch (_v280.ctor)
                                             {case "::":
                                                switch (_v280._0.ctor)
                                                  {case "_Tuple2":
                                                     switch (_v280._0._0.ctor)
                                                       {case "_Tuple2":
                                                          switch (_v280._0._0._0.ctor)
                                                            {case "Touch":
                                                               switch (_v280._0._0._1.ctor)
                                                                 {case "Start":
                                                                    switch (_v280._0._1.ctor)
                                                                      {case "_Tuple2":
                                                                         return $Maybe.Just(events._0._1._0 - _v280._0._1._0);}
                                                                      break;}
                                                                 break;}
                                                            break;}
                                                       break;}
         ...
         return function () {
            switch (diffTouch.ctor)
            {case "Just":
               return _U.cmp(diffTouch._0,
                 maxRange) < 0;
               case "Nothing":
               return function () {
                    var _v297 = {ctor: "_Tuple2"
                                ,_0: diffMouse
                                ,_1: lastTouch};
                    switch (_v297.ctor)
                    {case "_Tuple2":
                       switch (_v297._0.ctor)
                         {case "Just":
                            switch (_v297._1.ctor)
                              {case "Just":
                                 return _U.cmp(_v297._0._0,
                                   maxRange) < 0 && _U.cmp(_v297._1._0,
                                   minLast) > 0;
                                 case "Nothing":
                                 return _U.cmp(_v297._0._0,
                                   maxRange) < 0;}
   ...
   var onClick = A2($MouseTouch.messageOn,
   click,
   $Time.second);
   _elm.MouseTouch.Eval.values = {_op: _op
                                 ,click$: click$
                                 ,click: click
                                 ,start$: start$
                                 ,start: start
